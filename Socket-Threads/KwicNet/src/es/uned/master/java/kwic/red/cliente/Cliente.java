...
private int conexiones_realizadas=0;
	...
	public Cliente(InterfazCliente aux){
		interfaz=aux;
	}
...
//Procedimiento que llama a diferentes m�todos para realizar la comunicacion con el servidor y trata las posibles excepciones	
...
private void conectarAServidor() throws IOException
	...
	//	intentos_conexion++;
		//System.out.println("Intenta conectar: intentos de conexion: "+intentos_conexion);
...
//Procedimiento que establece los flujos de entrada/salida
private void crearFlujos() throws IOException
	    {
	System.out.print("Intenta acceder a los flujos");
		//Establecer flujo de salida de datos
		salida = new ObjectOutputStream( socketCliente.getOutputStream() );      
	    salida.flush();
	    //Establecer flujo de entrada de datos
	    entrada = new ObjectInputStream( socketCliente.getInputStream());
	    salida.writeObject("INICIO");//Enviamos el comando INICIO al servidor para poder recoger los datos Kwic
	    }
//Procedimiento que espera la recepcion de datos desde el servidor
...
private void procesarConexion() throws IOException
	    {
	          try {
	        	  ...
	        	  if (datos_leidos instanceof DatosCliente){//Tenemos que escribir los datos en los text areas
			        		System.out.println("Es un objeto de tipo datos_servidor");//***********************
			        		actualizar_datos((DatosCliente)datos_leidos); 
			        		interfaz.setBotonGuardar(true); //Como ya hay datos en los textArea habilitamos el boton guardar
	        	  }
...
public void cerrarConexion(){
		try{
			...
			interfaz.setEstadoConexion(false);
			interfaz.setBotonDesconectar(false);
    		interfaz.setBotonConectar(true);
	        salida.close();
	        entrada.close();
	        socketCliente.close();
			System.out.println("*************************************************************************");
...
//Procedimiento que actualiza los campos de texto de la interfaz grafica
private void actualizar_datos(final DatosCliente aux){
	
	        interfaz.setAreaNoClaves(aux.noClaves);
	        interfaz.setAreaKwic(aux.kwicResultado);
	        interfaz.setAreaFrases(aux.titulo);	
