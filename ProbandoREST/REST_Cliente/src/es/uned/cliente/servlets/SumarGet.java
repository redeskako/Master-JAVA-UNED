 ...
 */
public class SumarGet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String a = request.getParameter("suma_a");
		String b = request.getParameter("suma_b");
		
		// Se crea el cliente:
		Client cliente = ClientBuilder.newClient();
		
		// Se indica a dónde va a lanzar su consulta:
		WebTarget recurso = cliente.target("http://localhost:8080/REST_Servidor/rest/calculadora?a="+a+"&b="+b);
