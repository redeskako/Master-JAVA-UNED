...
public class DatosClientes {
    ...
    public Statement abrirConexion() {
    	try{
    		...
    		con=  DriverManager.getConnection("jdbc:mysql://localhost/Rizos_Bd?user=usuario&password=Arelinux");
    ...
    public DatosClientes obtenerCliente(int id) {
        ...
        try {
            ...
            String sql = "select id,dni,nombre,apellido1,apellido2,direccion,codigopostal,localidad," +
            		"provincia,telefono,observaciones,tipoUsuario,usuario,pass from usuario where id='"+id+"';";
    ...
    public void editarCliente(DatosClientes cliente) {
        try {
          String sql ="update usuario set nombre='"+cliente.getNombre()+"', apellido1='"+cliente.getApellido1()+"', apellido2='"+cliente.getApellido2()+"', dni='"+cliente.getDni()+"'," +
          		" codigopostal='"+cliente.getCodigopostal()+"', localidad='"+cliente.getLocalidad()+"', provincia='"+cliente.getProvincia()+"', telefono='"+cliente.getTelefono()+"', observaciones='"+cliente.getObservaciones()+"', tipoUsuario='"+cliente.getTipoUsuario()+"', usuario='"+cliente.getUsuario()+"', pass='"+cliente.getPass()+"' where id='"+cliente.getId()+"'";
            st=this.abrirConexion();
