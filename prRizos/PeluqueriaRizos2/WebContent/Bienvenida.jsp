...
<form action="ProcesaLogado2" method="post">
<center>
<table class="tabla">
	<tr>
		<th class="mod1">Usuario:</th>
		<th class="mod1"><input type="text" name="usuario" /></th>
	</tr>
	<tr>
		<th class="mod1">Contraseña:</th>
		<th class="mod1"><input type="password" name="password" /></th>
	</tr>
</table>
<br>
<tr>
	<td><input type="image" src="template/enviar.jpg" name="submit"
		value="Logarse" alt="enviar" /></td>
</tr>
<br>
<br>
<br>
<tr>
	<td><a href="AltaCliente.jsp"> <img src="template/nuevo1.jpg"
		alt="insertar" border="none"></a> <br>
	<br>
	<br>
	<br>
	<br>
...
<%
	...
	switch (valido.intValue()){
		...
		case -3: str="Usuario,dni o pass ya existen.";break;
