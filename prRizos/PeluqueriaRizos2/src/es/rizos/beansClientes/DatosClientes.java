...
public class DatosClientes {
    ...
    //metodo q obtiene los datos de un cliente para mostrarselos cdo se editan sus datos
    public DatosClientes obtenerCliente(int id) {
        ...
        try {
            ...
            String sql = "select id,dni,nombre,apellido1,apellido2,direccion,codigopostal,localidad," +
            		"provincia,telefono,direccion,observaciones,tipoUsuario,locale,usuario,pass from usuario where id='"+id+"';";
            ...
            if (rs.next()) {
                ...
                cliente.setLocale(rs.getString("locale"));
    ...
    public void editarCliente(DatosClientes cliente) {
        try {
        	...
        	" telefono='"+cliente.getTelefono()+"',direccion='"+cliente.direccion+"',observaciones='"+cliente.getObservaciones()+"'," +
     		" usuario='"+cliente.getUsuario()+"'," + "locale='"+cliente.getLocale()+"'," +
   ...
   //meotodo q inserta un nuevo cliente
    public void insertarCliente(DatosClientes cliente) {
      try{
    	  String sql=
        		"insert into usuario (nombre, apellido1, apellido2, direccion,activo, dni, codigopostal, localidad, provincia, telefono,observaciones, tipoUsuario,locale,usuario, pass) values ('"+cliente.getNombre()+"','"+cliente.getApellido1()+"','"+cliente.getApellido2()+"','"+cliente.getDireccion()+"','"+1+"','"+cliente.getDni()+"','"+cliente.getCodigopostal()+"','"+cliente.getLocalidad()+"','"+cliente.getProvincia()+"','"+cliente.getTelefono()+"','"+cliente.getObservaciones()+"','"+cliente.getTipoUsuario()+"','"+cliente.getLocale()+"','"+cliente.getUsuario()+"','"+cliente.getPass()+"')";
