...
import es.csc.biblioteca.customers.gui.CustomersManagementView;
...
public class DesktopMDIController implements ActionListener, WindowListener, Observer {
    ...
    private void addJInternalFrame(JInternalFrame frame) {
        ...
        // ajuste de tamaño para el interfaz CustomerManagementView
        if(frame instanceof CustomersManagementView)
            height+=100;
    ...
    private void changeLanguage(String language) {
        switch (language) {
            ...
            case "en_US":
                ...
                break;
            case "fr_FR":
                LocaleManager.getInstance().setLocale(new Locale("fr", "FR"));
                break;
            default:
                LocaleManager.getInstance().setLocale(new Locale("en", "US"));
                break;
