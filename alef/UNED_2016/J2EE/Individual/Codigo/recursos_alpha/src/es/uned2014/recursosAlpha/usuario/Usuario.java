...
public class Usuario implements Comparable<Object> {
	...
	public static final int ROLE_EMPLEADO = 1;
	public static final int ROLE_RESPONSABLE = 2;
	...
	/**
	 * @param nombreUsuario establecido
	 */
