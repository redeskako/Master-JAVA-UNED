...
public class Reserva implements Comparable<Object>{
	 ...
	 */
	public ArrayList<Reserva> misPeticiones(int usuario, int pagina){
		...
		String sql = " SELECT * FROM `reservas` AS res "
				   ...
				   + " WHERE res.IdEstado = '1' AND res.IdUsuario='" + usuario + "' "
	 ...
	 */
	public ArrayList<Reserva> misReservas(int usuario, int pagina){
		...
		String sql = " SELECT * FROM `reservas` AS res "
				   ...
				   + " LEFT JOIN usuarios AS u ON u.IdUsuario = res.IdUsuario "
				   + " LEFT JOIN estados AS e ON e.IdEstado = res.IdEstado "
				   + " WHERE res.IdEstado IN (2,4,6) AND res.IdUsuario='" + usuario + "' "
				   + " ORDER BY	res.Inicio DESC "
				   + " LIMIT "+limit+",20 ";
	 ...
	 */
	public String sqlBuscadorReservas(int vista, int u, int r, Date iniD, Date iniH, Date finD, Date finH, int e){
		...
		if (iniD != null && iniH != null && !iniD.equals(fechaCero) && !iniD.equals(fechaCero)){
		...
		if (finD != null && finH != null &&  !finD.equals(fechaCero) && !finD.equals(fechaCero)){
	 ...
	 */
	public boolean comprobarUsuario(int usuario, int idReserva){
