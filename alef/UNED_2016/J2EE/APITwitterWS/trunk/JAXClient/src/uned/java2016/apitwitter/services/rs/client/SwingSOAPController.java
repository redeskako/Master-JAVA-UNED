 ...
 * 
 * @author José Barba Martínez y grupo Uned Java 2016.
 *
 */
public class SwingSOAPController {

	/**
	 * URL base de los endpoints. Solo usado para ser mostrado en la pestaña.
	 */
	public static final String WS_WEBCONTEXT="/APITwitterWeb/services/soap";
	/**
	 * Frame principal
	 */
	...
	protected void manageLogic(){
		...
		this.getGoOp().addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				SwingSOAPController.this.doBusiness();
			}
	...
	protected void manageView(){
		...
		this.getComboOperationRS().addItemListener(new ItemListener(){
			...
			public void itemStateChanged(ItemEvent e) {
				...
				JPanel p=SwingSOAPController.this.getParametersWS();
		...
		this.getFrame().addComponentListener(new ComponentAdapter(){
		     ...
		     public void componentResized(ComponentEvent e){
		    	 JFrame f=SwingSOAPController.this.getFrame();
		...
		switch(this.getComboOperationRS().getSelectedItem().toString())
		{
			...
			case "getByNCT":
				...
				objetoRecuperado = "TÍTULO BREVE======== " + "\n" + s.getBriefTitle() + "\n" +
					...
					objetoRecuperado= "NO SE HA RECUPERADO NINGÚN ESTUDIO CON ESTE NCT_ID";
				}
				break;
			case "getNeighbour":
			...
			case "getByEstudio":
				...
				Estudios studies = clst.getByHashtag(this.getTxtGetByEstudio().getText(),Integer.parseInt(this.getTxtGetByEstudio_count().getText()));
