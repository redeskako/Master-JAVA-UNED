...
public class NeighbourMessageBodyReader implements MessageBodyReader<List<String>> 
{
	...
	public List<String> readFrom(Class<List<String>> arg0, Type arg1, Annotation[] arg2, MediaType arg3,
		...
		// TODO Auto-generated method stub
		/*try {
	        JAXBContext jaxbContext = JAXBContext.newInstance(Clinicals.class);	        
	        JAXBElement<Clinicals> element=jaxbContext.createUnmarshaller()	        		
		            .unmarshal((Source) new StreamSource(entityStream),Clinicals.class);	        
