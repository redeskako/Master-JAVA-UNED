...
public class SwingClient {
	...
	private JTextField txtGetNeighbourSOAP_hashtag;
	...
	public static final String cardOp_getNeighbour="getNeighbourRS";
	public static final String cardOp_getNeighbourWS="getNeighbourWS";
	...
	public SwingClient(SwingController cont){
		...
		cont.setTxtGetNeighbourSOAP_hashtag(this.txtGetNeighbourSOAP_hashtag);
	...
	private void initialize() {
		...
		String[] comboItems={this.cardOp_getById,this.cardOp_getByHashtag,this.cardOp_getNeighbour,this.cardOp_getNeighbourWS};
		...
		JPanel parameterWS_getNeighbourSOAP = new JPanel();
		parametersWS.add(parameterWS_getNeighbourSOAP, cardOp_getNeighbourWS);
		
		JLabel lblNewLabel_8 = new JLabel("Hashtag");
		parameterWS_getNeighbourSOAP.add(lblNewLabel_8);
		
		txtGetNeighbourSOAP_hashtag = new JTextField();
		parameterWS_getNeighbourSOAP.add(txtGetNeighbourSOAP_hashtag);
		txtGetNeighbourSOAP_hashtag.setColumns(20);
