	...
	protected void doBusiness(){
		...
		switch(this.getComboOperationRS().getSelectedItem().toString())
		{
			case "getById":
				...
				break;
			case "getByHashtag":
				objetoRecuperado = (c.getByHashtag(this.getTxtURI().getText()+this.WS_WEBCONTEXT,this.getTxtGetByHashtag_hashtag().getText(),Integer.parseInt(this.getTxtGetByHashtag_count().getText()))!=null ? "List<ClinicalStudy>" : null);
				break;
		}		
