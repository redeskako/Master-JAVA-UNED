...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<!-- To use this class in your javascript you will need 
		the following script includes: -->
		<script type='text/javascript' src='/APITwitterWeb/dwr/interface/GetTweets.js'></script>
  		<script type='text/javascript' src='/APITwitterWeb/dwr/engine.js'></script>
		<!-- In addition there is an optional utility script:  -->
  		<script type='text/javascript' src='/APITwitterWeb/dwr/util.js'></script>
						...
						<c:if test="${losTweets!=null}">
							...
							<div id="capa_principal" class="misZonas">
								...
								<div id='zonaResultadosGeneral'>
									<c:forEach var="i" begin="1" end="${losTweets.size()-1}">
