...
public class Inicializar extends TagSupport{
	...
	public int doStartTag() throws JspException {
        ...
        this.pageContext.setAttribute("elUsuario",Inicializar.usuario);
        ...
        if(usuario != null){
        	...
        	if(Inicializar.miHashtag==null){
        		miGetTweets=new GetTweets();
        		if(miGetTweets.getHashtag()!=null){
        			Inicializar.miHashtag=miGetTweets.getHashtag();
        		}
        	}
