	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(action.equals("delete")){
	        ...
	        response.sendRedirect("/WorldHealthBank_Boza/data?action=get&pag=1");
        	 ...
        	 request.setAttribute("datas", dataDao.getDataPagination(pag-1, 20));
        	 request.setAttribute("paginaActual", pag);
        	 request.setAttribute("numeroPaginas", (dataDao.getNumeroPaginas()%20 == 0)?dataDao.getNumeroPaginas()/20:dataDao.getNumeroPaginas()/20+1);
		     ...
		     view.forward(request, response);
				...
				if(request.getParameter("Indicador") != ""){
				    ...
				    request.setAttribute("healthIndicators", healthIndicatorDao.getAllHealth());
