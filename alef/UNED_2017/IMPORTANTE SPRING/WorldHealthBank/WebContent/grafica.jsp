    ...
    <table class="login-form" border=1>
        ...
        <tbody>
        	<% for (int i = 0; i < listilla.size(); i++) { %>
                ...
                <tr>
                    <td> <% out.print(listilla.get(i).getIndicador_code());%> </td>
                    <td> <% out.print(listilla.get(i).getCountry_code()); %> </td>
                    <td> <% out.print(listilla.get(i).getYear()); %> </td>
                    <td> <% out.print(listilla.get(i).getPercentage()); %> </td>
                </tr>
             <%} %>
        </tbody>
    </table>
