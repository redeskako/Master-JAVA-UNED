...
public class Indicador implements Registro, Serializable {
	...
	private String codigo; 			//El c�digo del indicador de salud (indicator_code de la tabla HEALTH_INDICATOR en la Base de Datos)
	...
	/**
	 * Constructor de la clase Indicador sin par�metros
	...
	/**
	 * @return El c�digo del indicador de salud (indicator_code de la tabla HEALTH_INDICATOR en la Base de Datos)
	 */
	...
	/**
	 * @param codigo El c�digo del indicador de salud (indicator_code de la tabla HEALTH_INDICATOR en la Base de Datos)
	 */
