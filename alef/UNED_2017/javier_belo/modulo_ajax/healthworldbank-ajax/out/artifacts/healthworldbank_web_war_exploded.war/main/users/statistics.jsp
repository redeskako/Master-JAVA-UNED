...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/module-ajax.js"></script>
        ...
        <div id="left-panel">
            <form id="form-statistics" action="${pageContext.request.contextPath}/main/users/statistics" onsubmit="return validateForm()" method="get" autocomplete="off">
                <fieldset>
                    ...
                    <input type="text" id="country-hint" name="country" onkeyup="search(event)">
                </fieldset>
