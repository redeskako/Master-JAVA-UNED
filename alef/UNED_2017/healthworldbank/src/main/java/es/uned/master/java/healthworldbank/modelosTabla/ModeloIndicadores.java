...
/**
 * Clase especializada en indicadores
 */
public class ModeloIndicadores  extends CustomAbstractTableModel {
...
public void addAllRows(ArrayList<Registro> datos) {
    ArrayList<Indicador> ale = (ArrayList<Indicador>)(ArrayList<?>) datos;
