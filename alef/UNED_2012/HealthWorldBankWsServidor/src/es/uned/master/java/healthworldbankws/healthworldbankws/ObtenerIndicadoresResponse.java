...
/**
 * ObtenerIndicadoresResponse.java
 *
 ...
 */
            ...
            /**
            *  ObtenerIndicadoresResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ObtenerIndicadoresResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://healthworldbankws.java.master.uned.es/HealthWorldBankWs/",
                "ObtenerIndicadoresResponse",
                "ns1");
                        ...
                        */
                                    ...
                                    protected es.uned.master.java.healthworldbankws.healthworldbankws.IndicadorType[] localIndicador ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           ...
                           public boolean isIndicadorSpecified(){
                               return localIndicadorTracker;
                           }
                           ...
                           /**
                           * Auto generated getter method
                           * @return es.uned.master.java.healthworldbankws.healthworldbankws.IndicadorType[]
                           */
                           public  es.uned.master.java.healthworldbankws.healthworldbankws.IndicadorType[] getIndicador(){
                              ...
                              /**
                               * validate the array for Indicador
                               */
                              protected void validateIndicador(es.uned.master.java.healthworldbankws.healthworldbankws.IndicadorType[] param){
                              ...
                              */
                              public void setIndicador(es.uned.master.java.healthworldbankws.healthworldbankws.IndicadorType[] param){
                              
                                   validateIndicador(param);

                               localIndicadorTracker = param != null;
                             ...
                             * @param param es.uned.master.java.healthworldbankws.healthworldbankws.IndicadorType
                             */
                             public void addIndicador(es.uned.master.java.healthworldbankws.healthworldbankws.IndicadorType param){
                                   if (localIndicador == null){
                                   localIndicador = new es.uned.master.java.healthworldbankws.healthworldbankws.IndicadorType[]{};
                                   }
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localIndicador);
                               list.add(param);
                               this.localIndicador =
                             (es.uned.master.java.healthworldbankws.healthworldbankws.IndicadorType[])list.toArray(
                            new es.uned.master.java.healthworldbankws.healthworldbankws.IndicadorType[list.size()]);
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ObtenerIndicadoresResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ObtenerIndicadoresResponse",
                           xmlWriter);
                              ...
                              if (localIndicadorTracker){
                                       if (localIndicador!=null){
                                            for (int i = 0;i < localIndicador.length;i++){
                                                if (localIndicador[i] != null){
                                                 localIndicador[i].serialize(new javax.xml.namespace.QName("","Indicador"),
                                                           xmlWriter);
                                                } else {
                             ...
                             if (localIndicador!=null) {
                                 for (int i = 0;i < localIndicador.length;i++){
                                    ...
                                    if (localIndicador[i] != null){
                                         elementList.add(new javax.xml.namespace.QName("",
                                                                          "Indicador"));
                                         elementList.add(localIndicador[i]);
                                    } else {
    ...
    public static class Factory{
        ...
        */
        public static ObtenerIndicadoresResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ObtenerIndicadoresResponse object =
                new ObtenerIndicadoresResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ObtenerIndicadoresResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ObtenerIndicadoresResponse)es.uned.master.java.healthworldbankws.healthworldbankws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list4 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","Indicador").equals(reader.getName())){
                                
                                    
                                    
                                    // Process the array and step past its final element's end.
                                    list4.add(es.uned.master.java.healthworldbankws.healthworldbankws.IndicadorType.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone4){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("","Indicador").equals(reader.getName())){
                                                                    list4.add(es.uned.master.java.healthworldbankws.healthworldbankws.IndicadorType.Factory.parse(reader));
                                                        ...
                                                        object.setIndicador((es.uned.master.java.healthworldbankws.healthworldbankws.IndicadorType[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                es.uned.master.java.healthworldbankws.healthworldbankws.IndicadorType.class,
                                                                list4));
