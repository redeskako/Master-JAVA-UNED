...
public class AppletWHB extends JApplet implements ActionListener, MouseListener{
	...
	private void inicializarInterfaz(){
		...
		add(tabbedPane, "Panel_pestannas");
        
		JPanel panel_1 = new JPanel();
		tabbedPane.addTab("Datos", null, panel_1, null);
        ...
        panel_1.add(izquierda, BorderLayout.WEST);
        panel_1.add(grafica, BorderLayout.EAST);
		...
		tabbedPane.addTab("Mapa", null, panel_2, null);
