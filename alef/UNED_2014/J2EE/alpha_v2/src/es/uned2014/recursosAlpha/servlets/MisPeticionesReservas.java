...
public class MisPeticionesReservas extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) 
		...
		Integer usuario = (Integer) session.getAttribute("idSesion");
		...
		case "peticiones":
			...
			int numFilas = r.totalFilasReserva(usuario);
		...
		case "reservas":
			...
			int numFilas2 = r.totalFilasReserva(usuario);
