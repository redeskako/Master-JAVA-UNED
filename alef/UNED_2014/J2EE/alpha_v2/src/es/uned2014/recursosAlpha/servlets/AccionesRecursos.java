...
public class AccionesRecursos extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		case "listado":
			...
			requestDispatcher = request.getRequestDispatcher("recursosListado.jsp");
		...
		case "menuEditar":
			...
			// Se re-dirige a la página jsp:
			requestDispatcher = request.getRequestDispatcher("recursosEditar.jsp?idEditado="
		...
		case "buscador":
			...
			// Se re-dirige a la página jsp:
			requestDispatcher = request.getRequestDispatcher("recursosBuscador.jsp?busqueda=" + busqueda);
			requestDispatcher.forward(request, response);
