...
<body>
	...
	<div id="container">
		...
		<div id="content">
			...
			<form name="formEditarReserva" action="./MisPeticionesReservas" method="get" onsubmit="return controlForm();">
				<div class="cntCampo">
					<input type="hidden" name="usuario" value="<%=new Usuario().getIdUsuario((String)session.getAttribute("idSesion"))%>">	
				</div> <!-- fin cntCampo -->
			...
			%>
				<div class="info">
					...
					<div>
						<a class="info_btn" href="./MisPeticionesReservas?tipo=eliminar&id=<%=idEliminar%>&nombre=<%=nombre%>" > Eliminar </a>
						<a class="info_btn" href="./MisPeticionesReservas?tipo=peticiones" > No eliminar </a>
					</div>
					<div style="clear: both"></div>
				</div> <!-- fin info -->
			<%			
			...
			%>
			<div class="info">
				La solicitud de reserva se ha eliminado correctamente.
			</div> <!-- fin info -->
			...
			%>
			<div class="info_error">
				La solicitud de reserva no se ha eliminado correctamente.
			</div> <!-- fin info_error -->
			...
			<table>
				...
				<tr>
					...
					<td class="boton">
						<a href="./MisPeticionesReservas?tipo=botonEditar&id=<%=p.getIdReserva()%>" class="btn" > Editar </a> 											
					</td>									
					<td class="boton">
						<a href="./MisPeticionesReservas?tipo=botonEliminar&id=<%=p.getIdReserva()%>&nombre=<%=p.getDescripcionRecurso()%>" class="btn">Eliminar</a> 										
					</td>
				</tr>
			...
			<div class="paginacion">
				...
				<ul>
					<%
						for (int pa = 1; pa <= paginas; pa++) {
					%>
					<li><a href="./MisPeticionesReservas?tipo=peticiones&p=<%=pa%>"><%=pa%></a></li>
					<%
						}
					%>
				</ul>
