	 ...
	 **/%>
			...
			<%
				// Dibuja la tabla de las peticiones pendientes
					...
					ArrayList<Reserva> tsR = (ArrayList<Reserva>) request.getAttribute("arrayReservas");
			...
			<table>
				...
				<tr
					...
					<td><%=r.getInicio().toString()%></td>
					<td><%=r.getFin().toString()%></td>
					<td><%=r.getEstado()%></td>
					<td class="boton">
						<a href="./Tareas?tipo=anular&id=<%=r.getIdReserva()%>&nombre=<%=r.getNombreUsuario()%>" class="btn">Anular</a> 						
					</td>
					<td class="boton">
						<a href="./Tareas?tipo=noAnular&id=<%=r.getIdReserva()%>&nombre=<%=r.getNombreUsuario()%>" class="btn">No anular</a> 		
					</td>
				</tr>
				<%
					} // fin while
			...
			<div class="paginacion">
				...
				<ul>
					...
					%>
					<li><a href="./Tareas?tipo=reservas&p=<%=p%>"><%=p%></a></li>
					<%
						}
					%>
				</ul>
			...
			%>
			<p>No tiene ninguna reserva pendiente de anular.</p>
			<%
				} // fin if
			%>
