<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%
	// Si ha accedido un empleado o responsable: se muestra el log de sesión iniciada
	...
	<%
	// Si no ha accedido un empleado o responsable: se muestra el log de sesión sin iniciar
	} else {
	%>
