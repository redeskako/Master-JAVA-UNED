package es.uned2014.oca.drivers;
...
public class DriverServidor extends JFrame implements ActionListener,WindowListener {
	...
	public DriverServidor() {
		...
		// Se crea el Panel superior donde estará el botón de comprobar nº
		// Jugadores
		...
		// Los opciónes de jugadores jugadores de 2 a 6 en un array
		...
		// Los opciónes de idioma en un array
