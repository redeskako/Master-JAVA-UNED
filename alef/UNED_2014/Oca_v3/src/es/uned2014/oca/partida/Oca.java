...
public class Oca {
	 ...
	 * 1º Se sitúan a todos los Jugadores en la Casilla 1
	 * 2º Se da el turno al Jugador
	 * 3º Se analiza el primer turno turno
	 * @param null
	 * @return null
	 * @throws null
	 */
	...
	/**
	 * Se inicia el turno:
	 * 1º Se comprueba si tiene castigos pendientes
	 * 2º Se informa a todos los jugadores del jugador que tiene el turno
	 * 3º Se envía comunicacion especial al jugador activo 
	 * @param null
	 * @return null
	 * @throws null
	 */
	...
	/**
	 * Se analiza el final del turno, comprobando si la partida continúa o no.
	 * @param null
	 * @return null
	 * @throws null
	 */
