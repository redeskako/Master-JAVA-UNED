 ...
 * Contiene además los métodos necesarios para describir las acciones que se llevan a cabo en el 
...
public class Tablero {
	...
	/**
	 * Se inicializa la colección arrayCasillas, colocando en el arrayCasillas 63 objetos Casilla, desde
	 ...
	 * Se comprueba si es la casilla final. Si es así, gana la partida y se termina la misma. Si no es así,
	 ...
	 * 		1º Se comprueba si es la Oca 63: en ese caso se termina la partida
	 * 		2º Si no es la 63, se desplaza a la siguiente Oca y repite turno el jugador.
	 * @param 	Jugador activo y Casilla destino.
	 * @return 	Se devuelve el objeto Casilla resultante de la tirada.
	 * @throws 	null
	 */	
	private Casilla accionesOca(Jugador j, Casilla casillaDestino){
		...
		if (casillaDestino.getPosicion() == 63){
			...
			// El método devuelve la Casilla destino
			return casillaDestino;
			
		} else{
			// Se define un valor entero i que corresponde a la posición de la Casilla dentro del ArrayList
	...
	/**
	 * Método que muestra en consola información para el jugador activo.
