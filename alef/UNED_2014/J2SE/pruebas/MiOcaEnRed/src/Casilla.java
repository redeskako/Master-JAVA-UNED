...
public class Casilla {
	...
	// Variable de valor entero que representa la posición de la Casilla en el Tablero
	...
	public Casilla (int i){
		// Precondición: que el valor que se va a asignar a la variable posicion esté entre 1 y 63:
		if(i<1 || i>63){
			throw new ClaseError("Posición de la casilla no comprendida entre 1 y 63");
		} else {
			posicion = i;
		}
	 ...
	 * @return null
	 * @throws ClaseError en caso de que el valor no esté comprendido entre 1 y 63
	 */
	public void setPosicion(int i) {
		// Antes de asignar el valor a la variable posicion, se comprueba que está en el rango 1-63.
		if (i<1 || i>63){
			throw new ClaseError("El valor de la posición de Casilla tiene que estar comprendido entre 1 y 63."); 
		}else{
			this.posicion = i;
		}
	}
