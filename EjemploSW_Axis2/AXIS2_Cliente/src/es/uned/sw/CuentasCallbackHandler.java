 ...
 */
    ...
    /**
     *  CuentasCallbackHandler Callback class, Users can extend this class and implement
     *  their own receiveResult and receiveError methods.
     */
    public abstract class CuentasCallbackHandler{
    ...
    */
    public CuentasCallbackHandler(Object clientData){
     ...
     public Object getClientData() {
        return clientData;
           ...
           public void receiveResultsumar(
                    es.uned.sw.CuentasStub.SumarResponse result
                        ) {
           }
