...
public class  BBDD {
	...
	public boolean abrirConexion(){
		...
		try{
			...
			this.conn = DriverManager.getConnection("jdbc:mysql://localhost/medlinebennett?user=root&password=root");
			this.conectado=true;
        } catch (SQLException e){
        	throw new HealthtopicException("Error al abrir la conexiÃ³n: " + e.getMessage());
