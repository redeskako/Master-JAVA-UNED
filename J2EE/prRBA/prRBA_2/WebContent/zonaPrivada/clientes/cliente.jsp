...
%>
	...
	<table border="0" cellspacing="0" cellpadding="2" width="440">
		...
		<table width="438" border="1">
          ...
          <tr>
          	<th width="103" scope="col"><a href="<%=path %>/zonaPrivada/clientes/cliente.jsp?campo='codigo'">Codigo</a></th>
            <th width="103" scope="col"><a href="<%=path %>/zonaPrivada/clientes/cliente.jsp?campo='nombre'">Nombre</a></th>
            <th width="96" scope="col"><a href="<%=path %>/zonaPrivada/clientes/cliente.jsp?campo='apellido1'">Apellido 1º</a></th>
            <th width="56" scope="col"><a href="<%=path %>/zonaPrivada/clientes/cliente.jsp?campo='apellido2'">Apellido 2º</a></th>
            <th width="56" scope="col"><a href="<%=path %>/zonaPrivada/clientes/cliente.jsp?campo='telefono'">Telefono</a></th>
            <th width="56" scope="col"><a href="<%=path %>/zonaPrivada/clientes/cliente.jsp?campo='correo'">Correo</a></th>
            <th width="56" scope="col"><a href="<%=path %>/zonaPrivada/clientes/cliente.jsp?campo='pass'">Pass</a></th>
            <th width="56" scope="col"><a href="<%=path %>/zonaPrivada/clientes/cliente.jsp?campo='cp'">Cp</a></th>
          ...
          <tr>
	            ...
	            <td><%=u.getPass() %></td>
	            <td><%=u.getCp() %></td>
	            <td width="63"><div align="center"><a href="<%=path %>/rba.clientes/AccionCliente.java?codigo=<%u.getCodigo();%>,accion=1" title="Eliminar Cliente">Eliminar</a></div></td>
	            <td width="84"><div align="center"><a href="<%=path %>/rba.clientes/AccionCliente.java?codigo=<%u.getCodigo();%>,accion=2" title="Modificar Cliente">Modificar</a></div></td>
	          </tr>
			   <tr>
					<%
						//Mostrar la paginación correspondiente
						int totalpaginas= Usuario.calculaTotalPaginas();
		  ...
		  <p>
		  	<form id="form1" name="form1" method="post" action="/rba.clientes/AccionCliente.java?accion=7">
                	Campo de Busqueda:
		    ...
		    <label>
							    ...
							    <a href="<%=path %>/rba.clientes/AccionCliente.java?codigo=null,accion=3" title="Añadir Cliente">Añadir Cliente</a>
		    </label>
		    <br />
