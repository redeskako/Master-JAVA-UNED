...
<tr bgcolor="#99ccff">
	...
	<form action="<%=path%>/AccionCliente?accion=<%=6%>&codigo=<%=codigo%>" method="post">
    	<table width="200" border="1">
          <caption>
            Formulario de Modificacion de Cliente
          </caption>
          <tr>
           ...
           <tr>
            ...
            <td><input name="txtNombreCliente" type="text" value="<%=u.getNombre()%>"></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><input name="txtCorreo" type="text" value="<%=u.getCorreo()%>"></td>
          </tr>
          <tr>
            <th scope="row">Password: </th>
            <td><input name="txtPass" type="text" value="<%=u.getPass()%>"></td>
          </tr>
          <tr>
            <th scope="row">Cp: </th>
