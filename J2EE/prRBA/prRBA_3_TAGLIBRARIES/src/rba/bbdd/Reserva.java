...
import java.text.ParseException;
	...
	public class Reserva implements Comparable<Reserva>{
		...
		public Reserva(int codigo, String fecha, String hora, String turno, int usuario, Integer cliente, int mesa){
			this.codigo = 0;
			this.fecha= fecha;
			this.hora= hora;
			this.turno= turno;
		...
		//para ello utilizaré dos métodos, en uno tendré la cadena fecha
		...
		public String recHora(){
			...
			private static Set<Reserva> ejecutaSQLReserva(String sql){
				...
				//INSERTA UNA RESERVA
				public void InsertarReserva(String Fecha,String Hora,String turno,int usuario,int cliente,int mesa)
				{
					Connection conn=null;
					Statement stm= null;
					...
					try{
						...
						String sql ="INSERT INTO RESERVAS (fecha,hora,turno,usuario,cliente,mesa)VALUES ('"+Fecha+"','"+Hora+"','"+turno+"',"+usuario+","+cliente+","+mesa+")";
				...
				//definimos una función para retornar el número del cliente

				// ACTUALIZA LA RESERVA

				public  void ActualizarReserva(Integer codigo,String fecha,String hora,String turno,int usuario,int cliente,int mesa){
					...
					try{
						...
						//Las M en mayúsculas o interpretará minutos!!
						...
						String sql = "UPDATE RESERVAS SET fecha = "+fecha2+",hora = '"+hora+"',turno = '"+turno+"',usuario = '"+usuario+"',cliente = '"+cliente+"',mesa = '"+mesa+"'WHERE codigo="+codigo+";";
						//Proceso el select
						PreparedStatement rst= conn.prepareStatement(sql);
						rst.executeUpdate();
