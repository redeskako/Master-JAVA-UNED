...
<form action="ServletCita?accion=registraCita" method="post">

<table cellpadding="0" cellspacing="0" class="tabla" border="2" >
<caption class="caption">REGISTRA CITA</caption>
<tr>
<th class="link">CodigoCita</th>
<th class="link"><input type="text" name="codigocita" size="30" maxlength"50" /></th>
</tr>
<tr>
<th class="link">dni</th>
<th class="link"><input type="text" name="dni" size="30" maxlength"50" /></th>
</tr>
<tr>
