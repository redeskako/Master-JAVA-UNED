...
<div id="main">
<TITLE>Calendar - Septiembre</TITLE>
</HEAD>
<br>
...
<TABLE BORDER="5" WIDTH="75%" align="center">
	<TR BGCOLOR="#008080" ALIGN="CENTER" VALIGN="TOP">
		...
		<H3><FONT FACE="Verdana" COLOR="#004000"> <FONT SIZE="2"><a
			href="August.jsp"><fmt:message key="agosto" bundle="${lang}"/></a></FONT> -<fmt:message key="septiembre" bundle="${lang}"/>- <FONT SIZE="2"><a
			href="October.jsp"><fmt:message key="octubre" bundle="${lang}"/></a></FONT></FONT></H3>
		</TD>
	</TR>
