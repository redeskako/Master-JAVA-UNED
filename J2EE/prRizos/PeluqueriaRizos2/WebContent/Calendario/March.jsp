...
<TABLE BORDER="5" WIDTH="75%" align="center">
	<TR BGCOLOR="#008080" ALIGN="CENTER" VALIGN="TOP">
		...
		<a href="February.jsp"><fmt:message key="febrero" bundle="${lang}"/></a></FONT> -<fmt:message key="marzo" bundle="${lang}"/>- <FONT SIZE="2">
		<a href="April.jsp"><fmt:message key="abril" bundle="${lang}"/></a></FONT></FONT></H3>
		</TD>
	</TR>
