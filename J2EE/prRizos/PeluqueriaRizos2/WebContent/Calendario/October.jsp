...
<TABLE BORDER="5" WIDTH="75%" align="center">
	<TR BGCOLOR="#008080" ALIGN="CENTER" VALIGN="TOP">
		...
		<H3><FONT FACE="Verdana" COLOR="#004000"> <FONT SIZE="2">
		<a href="September.jsp"><fmt:message key="septiembre" bundle="${lang}"/> </a></FONT> -<fmt:message key="octubre" bundle="${lang}"/>- <FONT SIZE="2">
		<a href="November.jsp"><fmt:message key="noviembre" bundle="${lang}"/></a></FONT></FONT></H3>
		</TD>
	</TR>
	...
	<TR BGCOLOR="#FF8000" ALIGN="RIGHT" VALIGN="TOP">
		...
		<TD><FONT FACE="Verdana" SIZE="1" COLOR="#000000"><a
			href="../ServletCita?accion=meterCitasSesion&fecha=<%=dia31String%>">31</a><BR>
		<BR>
		</FONT></TD>
		<TD BGCOLOR="#808080"><FONT FACE="Verdana" SIZE="1">&nbsp;<BR></TD>
	</TR>
