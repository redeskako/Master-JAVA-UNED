...
<TABLE BORDER="5" WIDTH="75%" align="center">
	<TR BGCOLOR="#008080" ALIGN="CENTER" VALIGN="TOP">
		...
		<a href="January.jsp"><fmt:message key="enero" bundle="${lang}"/></a></FONT> -<fmt:message key="febrero" bundle="${lang}"/>- <FONT SIZE="2">
		<a href="March.jsp" bundle="${lang}">Marzo</a></FONT></FONT></H3>
		</TD>
	</TR>
