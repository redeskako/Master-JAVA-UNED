...
<TABLE BORDER="5" WIDTH="75%" align="center">
	<TR BGCOLOR="#008080" ALIGN="CENTER" VALIGN="TOP">
		...
		<H3><FONT FACE="Verdana" COLOR="#004000"> <FONT SIZE="2"><a
			href="December.jsp"><fmt:message key="diciembre" bundle="${lang}"/></a></FONT> -<fmt:message key="enero" bundle="${lang}"/>- <FONT SIZE="2"><a
			href="February.jsp"><fmt:message key="febrero" bundle="${lang}"/></a></FONT></FONT></H3>
		</TD>
	</TR>
