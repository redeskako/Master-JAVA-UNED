...
public class TestCrawler {
	...
	public static void main(String[] args) {		
		// creamos el crawler
		Crawler cr=new Crawler(LogManager.getLogger(uned.java2016.apitwitter.twitter.crawler.Launcher.class));
		...
		// vamos a sacar el limite inferior de la busqueda
		   ...
		   searchRequest.setQuery("#disease");
		 ...
		 er.setLowerPollLimitId(idMasReciente-50000l);
		 cr.doConfigure(er);
		 // lanzamos el sondeo
