...
public class Launcher {
	...
	protected void prepare()
	  throws Exception {
          ...
          //El resto de este método es para fijar el tweet_id a partir del cual realizaremos la búsqueda.
          //Para evitar llegar al máximo permitido sin haber recogido tweets.
          //Lo que se hace es lanzar una búsqueda y recuperamos el max_id actual para comprarlo con el guardado en base de datos.
		   ...
		   //Actualizamos el max_id de la BD si consideramos que es muy antiguo.
		   //La máxima búsqueda se realiza sobre 100000 tweets.
		   if (tweetbd.selectMaxId()<(idMasReciente-100000l)){
			   //tweetbd.insertMaxId(idMasReciente-100000l);
			   this.setLastMaxId(idMasReciente-100000l);
		   }
