...
public class BGuiLibros extends JInternalFrame implements ActionListener{
	...
	public BGuiLibros(String titulo,String local){
		super(titulo,
		          true, //resizable
		          true, //closable
		          true, //maximizable
		...
		this.propiedad.addItem(this.idioma.traduce("_AUTOR"));
		this.propiedad.addItem(this.idioma.traduce("_TEMA"));
		...
		try{
			switch (c){
				case 'B':
						...
						if (campo.equalsIgnoreCase(this.idioma.traduce("_AUTOR"))){
							razonbusqueda=CLibros.BUSQUEDAAUTOR;
						}
						if (campo.equalsIgnoreCase(this.idioma.traduce("_TEMA"))){
