...
/**
 * Clase para crear estilos de mapa personallizados
 * Created by javierbelogarcia on 18/02/2017.
 */
...
public class StyleLab {
    ...
    private Style createStyle2(FeatureSource featureSource) {
        ...
        if (Polygon.class.isAssignableFrom(geomType)
            ...
            return createPolygonStyle(null);
     ...
     * a cyan fill
     */
    public Style createPolygonStyle(Color fillColor) {
