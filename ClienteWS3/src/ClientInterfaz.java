...
public class ClientInterfaz extends javax.swing.JFrame {
    ...
    private int total = 0; //Almacena el número total de resultados obtenidos en la búsqueda
    ...
    private void jRButtonBuscarActionPerformed(java.awt.event.ActionEvent evt) { 
		...
		*/
    	...
    	//TODO Incluir información en el JLabel pendiente de crear
    	if (total==0){
    		jInfo.setText("No hay ningún resultado que contenga la palabra " + palabra + ".");
    	}
    	else{
    		jInfo.setText("Mostrando los resultados del " + indice + " al " + (indice + 10) + " de un total de " + total + " resultados.");
    	}
