...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="java.util.Vector" import="com.tomcat.prueba.Libro"   
%>
<%@ taglib uri="WEB-INF/libreria.tld" prefix="libros" %>
...
<%-- 		<libros:itera><option></libros:itera></option> --%>
	<libros:itera/>
	</select>
...
%>
	<tr>
		...
		<td><a href="index.jsp?producto=<%= productos.get(i).getId() %>&submit=eliminar">Eliminar</td>
	</tr>
<%
		}
		if (productos.size() == 0){
