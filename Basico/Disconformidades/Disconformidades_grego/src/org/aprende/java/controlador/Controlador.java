...
public class Controlador implements ActionListener{
	...
	private void primero(){
		this.ventana.setvalores (dis.first());
    	cont=0;
...
*/			
			...
			this.ventana.setvalores (this.arr.get(this.arr.size()-1));
			cont=this.arr.size()-1;
			System.out.println("Ultimo:"+cont);
			...
			Disconformidad d =new Disconformidad();
			//d.motivo("A ver si esto pone algo");
			this.ventana.setvalores(d);
