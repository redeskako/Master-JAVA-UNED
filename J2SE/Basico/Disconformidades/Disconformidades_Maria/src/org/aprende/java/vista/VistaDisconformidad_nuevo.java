...
public void llenarcombo (Servicios s){
        ...
        for (Iterator it=s.iterator(); it.hasNext( ); ) { 
             servicioorigen.addItem(it.next());
    ...
    public void setvalores(Disconformidad d){
    	this.documentosafectados.setText(d.docs());
   	 	...
   	 	//this.servicioorigen.setSelectedItem(d);
   	    this.servicioorigen.setSelectedIndex(d.servicio()-1);
    }
    
    public Disconformidad getvalores(Disconformidad d){
    	Date hoy = new 	Date();
    ...
    //m�todo que carga el combo de servicios con los valores de la base de datos
    public  void llenaComboServicios(){
		...
		while (iteraServi.hasNext()){  // recorro el TreeSet de Servicios
			...
			this.servicioorigen.addItem(nombre.toString());  //a�ado el servicio al combo de servicios
		}
		this.servicioorigen.setEnabled(true);
    }
    
    //m�todo que carga el combo de usuarios con los valores de la base de datos
    public void llenaComboUsuarios(){
		...
		while (iteraUsu.hasNext()){  // recorro el TreeSet de Usuarios
			...
			this.usuario.addItem(nombre.toString());  //a�ado el usuario al combo de usuarios
		}
		this.usuario.setEnabled(true);
    }
