/**
 * Clase para realizar operaciones comunes y pruebas con la BD
 * aparte de la aplicación principal. En realidad, tan solo se 
 * emplea para crear la BD de nuevo si la borramos.
 */
...
public class OperacionesBD
{
	public static void main( String args[] )
	{
		...
		try
		{
			...
			//EJECUTAR LA PRIMERA VEZ PARA CREAR LA TABLA
			// Crea la tabla.
			/*
		    ...
		    */		    
		    ...
		    while (rs.next())
		    {
		    	...
		    	System.out.println("Plaza: " + rs.getInt("plaza")); //Plaza a�adida
