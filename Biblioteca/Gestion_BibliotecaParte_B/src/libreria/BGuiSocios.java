...
public class BGuiSocios extends JInternalFrame implements ActionListener{
	...
	public BGuiSocios(String titulo,String local){
		super(titulo,
		          true, //resizable
		          true, //closable
		          true, //maximizable
		...
		this.propiedad.addItem(this.idioma.traduce("_DNI"));
		this.propiedad.addItem(this.idioma.traduce("_NOMBRE"));
		this.propiedad.addItem(this.idioma.traduce("_APELLIDOS"));
		this.propiedad.addItem(this.idioma.traduce("_DIRECCION"));
		...
		this.libreria= new CSocios(this.idioma);
	...
	public void actualizaIdioma(String local){
		...
		this.propiedad.addItem(this.idioma.traduce("_APELLIDOS"));
		this.propiedad.addItem(this.idioma.traduce("_DIRECCION"));
		this.propiedad.addItem(this.idioma.traduce("_FECHAALTA"));
		...
		try{
			switch (c){
				case 'B':
						...
						if (campo.equalsIgnoreCase(this.idioma.traduce("_DNI"))){
							razonbusqueda=CSocios.BUSQUEDADNI;
						}
						if (campo.equalsIgnoreCase(this.idioma.traduce("_NOMBRE"))){
							razonbusqueda=CSocios.BUSQUEDANOMBRE;
						}
						if (campo.equalsIgnoreCase(this.idioma.traduce("_APELLIDOS"))){
							razonbusqueda=CSocios.BUSQUEDAAPELLIDOS;
						}
						if (campo.equalsIgnoreCase(this.idioma.traduce("_DIRECCION"))){
