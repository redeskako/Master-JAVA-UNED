...
public class Prestamo implements Comparable<Prestamo>,Serializable{
	...
	private Config idioma;
			...
			private String [] iniciaNOMCOL(){
					...
					this.NOMCOL[1]= this.idioma.traduce("_SOCIO");
					this.NOMCOL[2]= this.idioma.traduce("_LIBRO");
					this.NOMCOL[3]= this.idioma.traduce("_FECHAINICIO");
					this.NOMCOL[4]= this.idioma.traduce("_FECHAFIN");
					this.NOMCOL[5]= this.idioma.traduce("_ELIMINAR");
					return this.NOMCOL;
			}
	public Prestamo(int idPrestamo, String idSocio, String idLibro, java.sql.Date fechaInicio,java.sql.Date fechaFin,String local){
	...
	public boolean equals(Object o){
		try{
			...
			throw new ErrorLibreriaException (this.idioma.traduce("_NOPRESTAMO")+e);
		}
	}
