...
public class ReservaTest {
	...
	/**
	 * Se comprueba los peticiones asignado a un usuario y retornan un array con
	 * los reservas. Ademas se pasa una variable de la pagina que esta vieno el
	 * usuario
	 */
	@Test
	...
	/**
	 * Se comprueba los reservas asignado a un usuario y retornan un array con
	 * los reservas. Ademas se pasa una variable de la pagina que esta vieno el
	 * usuario
	 */
	@Test
	...
	/*
	 * @Test public void testTotalFilasReserva(){
	 * 
	 * }
	 */
	...
	/*
	 * @Test public void testReservasEstado(){
	 * 
	 * }
	 */

	/**
	 * Se comprueba que si se puede crear una reserva nueva con estado
	 * pendiente.
	 */
	@Test
	public void testNuevo() {
		...
		assertTrue(r.nuevo(1, 1, inicio, fin, 1, 1) != 0);
	}

	/*
	 * @Test public void testComprobarReserva(){
	 * 
	 * }
	 */
	...
	public void testEditarReserva() {
		...
		assertTrue(r.editarReserva(1, 1, 1, inicio, fin, 3, 1) != 0);
	}

	/*
	 * @Test public void testCambiarEstado(){
	 * 
	 * }
	 */
	...
	public void testElimiar() {
		...
		int idNuevo = r.nuevo(1, 1, inicio, fin, 1, 1);

		assertTrue(r.eliminar(idNuevo));
	}

	/*
	 * @Test public void testSqlBuscadorReservas(){
	 * 
	 * }
	 * 
	 * @Test public void testReservasBuscar(){
	 * 
	 * }
	 * 
