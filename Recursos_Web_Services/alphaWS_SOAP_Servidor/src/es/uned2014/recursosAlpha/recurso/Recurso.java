...
/**
 * Representa un recurso que se puede reservar por un usuario. Sus propiedades
 * son: - idRecurso: int - descripci髇: String
 * 
...
public class Recurso implements Comparable<Object> {
	 ...
	 * 
	 * @param i
	 *            entero (i) para el idRecurso
	 * @param s
	 *            String (s) para la descripci贸n
	 */
	...
	/**
	 * Crea un objeto BaseDatos, abre la conexi髇 y solicita que se ejecute una
	 * consulta antes de cerrar. Esta consulta obtiene todos los recursos de la
	 * p醙ina indicada (para obtener todos los recursos, pagina = 0)
	 * 
	 * @param pagina
	 ...
	 * 
	 * @param s
	 *            String con la descripci髇 del nuevo recurso
	...
	public int nuevo(String s) {
		...
		String sql = "INSERT INTO recursos (Descripcion) VALUES ('"
				+ descripcion + "')";
	...
	/**
	 * Crea un objeto BaseDatos, abre la conexi髇 y solicita que se ejecute una
	 * consulta antes de cerrar. Esta consulta elimina todas las reservas
	 * asociadas a un recurso, antes de eliminar el propio recurso.
	 * 
	 * @param i
	 ...
	 * 
	 * @param s
	 *            String con la descripci髇 introducida
	...
	/**
	 * Crea un objeto BaseDatos, abre la conexi髇 y solicita que se ejecute una
	 * consulta antes de cerrar. Esta consulta obtiene todas los recursos que
	...
	public ArrayList<Recurso> recursosBuscar(int pagina, String sql) {
		...
		String sql2 = "SELECT * FROM `recursos` " + sql + " LIMIT " + limit
				+ ",20 ";
	...
	public String toString() {
		String s = "IdRecurso: " + this.idRecurso + " | Descripcion: "
				+ this.descripcion;
		return s;
	} // fin toString
