...
/**
 * Representa un usuario que puede acceder o no a la aplicaci�n.
 * 
...
public class Usuario implements Comparable<Object> {
	 ...
	 * @param r para rol
	 */
	public Usuario(int id, String nu, String n, String a, String c, int idr, String r){
		this.idUsuario = id;
		this.nombreUsuario = nu;
		this.nombre = n;
		this.apellidos = a;
	...
	/**
	 * M�todo constructor, asigna valor s�lo a nombreUsuario:
	 * @param s para nombreUsuario
	 */
	...
	/**
	 * Se encripta la contrase�a para que en caso de acceso a la base de datos, no se tenga acceso a 
	 * las contrase�as de los usuarios.
	 * @param s String con la contrase�a original
	 * @return String con la contrase�a encriptada
	 */
	...
	/**
	 * M�todo que comprueba si una pareja de usuario y contrase�a existe en la base de datos.
	 * Si existe, devuelve el usuario. Si no, devuelve null.
	 * @param u String con el nombre de usuario
	 * @param c String con la contrase�a sin encriptar
	 */
	...
	/**
	 * Crea un objeto BaseDatos, abre la conexi�n y solicita que se ejecute una consulta antes de cerrar.
	 * Esta consulta obtiene todos los usuarios.
	 * @param pagina
	...
	/**
	 * Crea un objeto BaseDatos, abre la conexi�n y solicita que se ejecute una consulta antes de cerrar.
	 * Esta consulta obtiene todos los roles posibles para usuarios.
	 * @return array con usuarios est�ndar, uno por cada rol posible
	 */
	...
	/**
	 * Se obtiene el n�mero total de filas de la tabla de usuarios
	...
	/**
	 * Crea un objeto BaseDatos, abre la conexi�n y solicita que se ejecute una consulta antes de cerrar.
	 * Esta consulta crea una fila nueva en la tabla de usuarios.
	 * @param nu para el nombreUsuario
	 * @param n para el nombre
	 * @param a para los apellidos
	 * @param c para la contrase�a, que se encripta previamente
	 * @param i para el idRol
	 * @return id del nuevo usuario
	 * @throws Si no se puede crear el nuevo usuario, se lanza error
	 */
	...
	/**
	 * Crea un objeto BaseDatos, abre la conexi�n y solicita que se ejecute una consulta antes de cerrar.
	 * Esta consulta edita una fila en la tabla de usuarios.
	 ...
	 * @throws null
	 */
	public int editarUsuario(int id, String nu, String n, String a, String c, int i){
		int idUsuario = id;
		String nombreUsuario = nu;
		String nombre = n;
		String apellidos = a;
		...
		// Si el usuario no existe previamente, se modifica. Si ya existe, se env�a error.
		if (arrayU.isEmpty()){
			// Consulta para editar usuario:
			String sql2 = "UPDATE `usuarios` SET `NombreUsuario` = '" + nombreUsuario + "', "
	 ...
	 * @param i id del elemento a eliminar
	...
	public String sqlBuscadorUsuarios ( String nU, String n, String a, String r) {
		...
		// Si el nombreUsuario no est� vac�o en el formulario, se busca ese nombreUsuario
		if (!nU.equals("")){
			sql += " WHERE usu.nombreUsuario LIKE '%" + nU + "%'";
		} else {
			// Si el nombreUsuario est� vac�o en el formulario, se busca en todos los nombreUsuario
			// N�mero de usuarios:
	...
	/**
	 * Crea un objeto BaseDatos, abre la conexi�n y solicita que se ejecute una consulta antes de cerrar.
	 * Esta consulta obtiene todas las usuarios que cumplen los requisitos indicados.
	 * @param pagina
	...
	/**
	 * Se obtiene el n�mero total de filas de la tabla de usuarios para una b�squeda concreta
	...
	/**
	 * Representaci�n en String de un Usuario
	 */
	public String toString() {
		String s = "IdUsuario: " + this.idUsuario + " | NombreUsuario: " + this.nombreUsuario + " | Nombre: "
				+ this.nombre + " | Apellidos: " + this.apellidos + " | IdRol: " + this.idRol + " | Rol: " 
				+ this.rol;
		return s;
	} // fin toString
	
	/**
	 * Para comparar dos Usuarios, se comparan sus nombreUsuario, ignorando las may�sculas.
	 */
	...
	/**
	 * Dos Usuarios son iguales si sus nombreUsuario son iguales, ignorando las may�sculas.
	 */
