...
import es.uned.master.java.garajeGUI.capaDatos.ConexionBD;
import es.uned.master.java.garajeGUI.capaGestion.GestionFechas;
import es.uned.master.java.garajeGUI.capaGestion.GestionMensajes;
import es.uned.master.java.garajeGUI.capaVista.GarajeGUI;
import es.uned.master.java.garajeGUI.pojo.ErrorGaraje;
import es.uned.master.java.garajeGUI.pojo.Registro;
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// ----------------------------------------------------------------------------------------
			while (frame.isBarrera()){
				...
				//interesa que entren más coches de los que salen para mostrar el cartel lleno
				//Por ello generamos plazas que no existen y se liberan las que existen y están ocupadas
				planta=aleatorio(9);
				plaza= aleatorio(18);
