...
import es.uned.master.java.oca.excepciones.ClaseError;
...
public class TableroTest {
	...
	public void testAnalizarTiradaDado() {
		...
		// Se le pide al tablero que analice que un jugador está en la casilla 15 y saque un 8
	...
	public void testAnalizarTiradaNormal() {
		...
		// Se crea una Casilla origen
		Casilla c = new Casilla(15);
		// Se le pide al tablero que analice que un jugador está en la casilla 15 y saque un 2
	...
	public void testAnalizarTiradaOca() {
		...
		// Se crea una Casilla origen
		Casilla c = new Casilla(15);
		// Se le pide al tablero que analice que un jugador est� en la casilla 15 y saque un 3
	...
	public void testAnalizarTiradaPuente() {
		...
		// Se le pide al tablero que analice que un jugador está en la casilla 11 y saque un 1
	...
	public void testAnalizarTiradaDados() {
		...
		// Se le pide al tablero que analice que un jugador está en la casilla 52 y saque un 1
		Casilla resultado = tab.analizarTirada(j, c, 1);
	...
	public void testAnalizarTiradaPosada() {
		...
		// Se le pide al tablero que analice que un jugador está en la casilla 17 y saque un 2
		Casilla resultado = tab.analizarTirada(j, c, 2);
	...
	public void testAnalizarTiradaPozo() {
		...
		// Se le pide al tablero que analice que un jugador está en la casilla 29 y saque un 2
		Casilla resultado = tab.analizarTirada(j, c, 2);
	...
	public void testAnalizarTiradaCarcel() {
		...
		// Se le pide al tablero que analice que un jugador está en la casilla 49 y saque un 3
		Casilla resultado = tab.analizarTirada(j, c, 3);
	...
	public void testAnalizarTiradaLaberinto() {
		...
		// Se le pide al tablero que analice que un jugador está en la casilla 40 y saque un 2
		Casilla resultado = tab.analizarTirada(j, c, 2);
	...
	public void testAnalizarTiradaCalavera() {
		...
		// Se le pide al tablero que analice que un jugador está en la casilla 57 y saque un 1
		Casilla resultado = tab.analizarTirada(j, c, 1);
	...
	public void testAnalizarTirada63Rebote() {
		...
		// Se le pide al tablero que analice que un jugador está en la casilla 60 y saque un 4
	...
	public void testAnalizarTirada63DesdeOca() {
		...
		// Se crea una Casilla origen
		Casilla c = new Casilla(57);
		// Se le pide al tablero que analice que un jugador está en la casilla 57 y saque un 2
		Casilla resultado = tab.analizarTirada(j, c, 2);
	 ...
	 * Cuando un jugador llega a la casilla 63, se le envéa a la casilla 0, para diferenciarlo
	...
	public void testAnalizarTirada63Final() {
		...
		// Se crea una Casilla origen
		Casilla c = new Casilla(57);
		// Se le pide al tablero que analice que un jugador está en la casilla 57 y saque un 6
