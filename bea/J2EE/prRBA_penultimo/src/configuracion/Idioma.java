...
public class Idioma extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (action.equals(ESPANOL)) {
            ...
            parametros = (ArrayList) sesion.getAttribute("datosParametros");
            valores = (ArrayList) sesion.getAttribute("datosValores");

            for (int i = 0; i < parametros.size(); i++) {
                request.setAttribute((String) parametros.get(i), (String) valores.get(i));
                System.out.println("VALOR: " + parametros.get(i) + "/" + valores.get(i));
            }
