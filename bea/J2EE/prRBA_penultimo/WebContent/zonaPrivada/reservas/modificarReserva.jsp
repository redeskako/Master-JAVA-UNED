        ...
        <div class="tituloSubmenu">
            ...
            <span class="resultado">
                ...
                <div class="altaFormulario">
                    <form action="<%=path%>/AccionReserva?accion=6&codigo=${reserva.codigo}" method="post">
 		<span class="fila">
                    <fmt:message key="Fecha" bundle="${base}"/>:
                    <input name="txtFecha" type="text" value="${reserva.fecha}" >		
		</span>&nbsp;&nbsp;
 		<span class="fila">
                    <fmt:message key="Hora" bundle="${base}"/>:
                    <input name="txtHora" type="text" value="${reserva.hora}" >
		</span>    
                 <br />
 		<span class="fila">
