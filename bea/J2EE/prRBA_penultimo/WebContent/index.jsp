...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
        ...
        <link REL="Shortcut Icon" HREF="template/logoIco.ico" /> 
    ...
    <body>
        <div id="cabeceraFondo" >            
            <div id="cabecera_titulo">                
                <span class="titulo"><fmt:message key="membrete"/></span>
                <span class="slogan">| <fmt:message key="membrete_leyenda" /></span>
            </div>
        </div>
        <div id="menu">
            <span class="opcionesMenu">               
                <a href="cocina.jsp"><fmt:message key="menu_cocina" /></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="localizacion.jsp"><fmt:message key="menu_localizacion" /></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                <a href="carta.jsp"><fmt:message key="menu_carta" /></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="eventos.jsp"><fmt:message key="menu_eventos_especiales" /></a>&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="contacto.jsp"><fmt:message key="menu_contacto" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>                
            </span>  
        ...
        <div id="contenido">
            ...
            <div id="envioLogin">
                <form id="formLogin" name="form1" method="post" action="ProcesaLogado">
                    ...
                    <span class="fuente"><fmt:message key="usuario" />:</span><br />
                    <input type="text" name="usuario" id="usuario" />
                    <br />
                    <span class="fuente"><fmt:message key="password" />:</span><br />
                    <input type="password" name="password" id="password" />
                    <input style="width:150px" type="submit" name="submit" id="submit" value="<fmt:message key="btnEnviar" />" />
                </form>
                <c:if test="${exception < 0 }"><span class="error"></span><span class="exception">${str}</span></c:if>
          </div> 
            <span class="rightText">Gracias por utilizar RBA 1.0</span>     
        </div>
