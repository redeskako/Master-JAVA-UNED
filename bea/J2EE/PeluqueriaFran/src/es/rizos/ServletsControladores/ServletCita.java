 ...
 * ServletCitas.java
 *
 * Created on 21 de agosto de 2008, 4:37
 */
 ...
 public class ServletCita extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
	...
	protected void doService(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try{
                                        ...
                                        if ((sesion.getAttribute("AtributoFecha")==null)){
                                            response.sendRedirect("GestionaAdmin.jsp");
                                                ...
                                                try{
                                                    ...
                                                    System.out.println("ERROR.Ingreso de número de código inválido");
                                                    response.sendRedirect("GestionaAdmin.jsp");
                                                }
				...
				// Si NO OK Envio una pÃ¡gina por out de ERROR con un link a la index.html
				response.sendRedirect("GestionaAdmin.jsp");
			}
