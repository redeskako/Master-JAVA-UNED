...
public class DatosClientes {
    ...
    public void editarCliente(DatosClientes cliente) {
        try {
        	...
        	" telefono='"+cliente.getTelefono()+"', observaciones='"+cliente.getObservaciones()+"'," +
     		" tipoUsuario='"+cliente.getTipoUsuario()+"', usuario='"+cliente.getUsuario()+"'," +
   ...
   public boolean existeDNI(DatosClientes clientes){
	   ...
	   try {
	        	String sql= "SELECT count(*) as Total FROM usuario where dni='"+clientes.getDni()+"'";
	            st=this.abrirConexion();
	            st.executeQuery(sql);
	            ResultSet rs = st.getResultSet();
