...
public class Libro {
	...
	public static Vector<Libro> consulta(String sql){
		...
		// private donde_base_datos="localhost";
		 String donde_base_datos="localhost";
		 String user="autor";
		 String pass="autor";
		...
		try{
			...
			conn= DriverManager.getConnection("jdbc:mysql://localhost/autores", "autor", "autor"); // Conecto a la base de dato
			...
			while (rst.next()){
				Libro l= new Libro(rst.getInt("idLibro"),rst.getString("Libro")); // Saco el dato
