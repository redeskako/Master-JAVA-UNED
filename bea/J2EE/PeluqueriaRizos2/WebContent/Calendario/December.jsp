...
<TABLE BORDER="5" WIDTH="75%" align="center">
	<TR BGCOLOR="#008080" ALIGN="CENTER" VALIGN="TOP">
		...
		<H3><FONT FACE="Verdana" COLOR="#004000"> <FONT SIZE="2"><a
			href="November.jsp"><fmt:message key="noviembre"  bundle="${lang}"/></a></FONT> -<fmt:message key="diciembre"  bundle="${lang}"/>- <FONT SIZE="2"><a
			href="January.jsp"><fmt:message key="enero"  bundle="${lang}"/></a></FONT></FONT></H3>
		</TD>
	</TR>
