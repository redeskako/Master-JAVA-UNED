...
<TABLE BORDER="5" WIDTH="75%" align="center">
	<TR BGCOLOR="#008080" ALIGN="CENTER" VALIGN="TOP">
		...
		<H3><FONT FACE="Verdana" COLOR="#004000"> <FONT SIZE="2"><a
			href="July.jsp"><fmt:message key="julio" bundle="${lang}"/></a></FONT> -<fmt:message key="agosto" bundle="${lang}"/>- <FONT SIZE="2"><a
			href="September.jsp"><fmt:message key="septiembre" bundle="${lang}"/></a></FONT></FONT></H3>
		</TD>
	</TR>
