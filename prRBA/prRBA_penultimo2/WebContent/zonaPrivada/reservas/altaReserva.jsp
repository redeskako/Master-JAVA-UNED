...
<!-- Idioma -->
 ...
 <c:set var="fecha" value="${requestScope.fecha}"></c:set>
 <c:set var="hora" value="${requestScope.hora}"></c:set>
 <c:set var="reservado" value="${requestScope.reservado}"></c:set>
...
<div id="fondoGeneral"> 
        ...
        <div class="tituloSubmenu">
            ...
            <span class="resultado">
                <c:if test="${reservado != null}">
                    <c:if test="${reservado != 0}">
        ...
        <div class="altaFormulario">
 		...
 		<span class="fila">
                    ...
                    <input name="txtFecha" type="text" value="${fecha}">		
		</span>&nbsp;&nbsp;
 		<span class="fila">
                    <fmt:message key="Hora" bundle="${base}"/>:
                    <input name="txtHora" type="text" value="${hora}">
		</span>    
                 <br />
 		<span class="fila">
 		...
 		<span class="fila">
                    ...
                    <select name="CmbCliente" id="CmbCliente" onChange="MM_jumpMenu('parent',this,0)">
                            <c:forEach var="cliente" items="${clientes}">    
                                    <option value="${cliente.codigo}" selected>  ${cliente.apellido1} - ${cliente.apellido2} , ${cliente.nombre}</option>
                            </c:forEach>
                    </select>
		</span>      
                 <br />
 		<span class="fila">
                    ...
                    <select name="CmbMesa" id="CmbMesa" onChange="MM_jumpMenu('parent',this,0)">
		            	...
		            	<option value="${mesa.codigo}" selected> Mesa: ${mesa.codigo} - Sillas: ${mesa.sillas}</option>
                            </c:forEach>
            ...
            <input style="width:150px" name="txtAceptar" type="submit" value="<fmt:message key="AnadirReserva" bundle="${base}"/>">          
            </form>	
