 ...
 * generated in the es.uned.sw package. 
...
public class ObjectFactory {
    ...
    private final static QName _SumarResponse_QNAME = new QName("http://sw.uned.es/", "sumarResponse");
    private final static QName _Sumar_QNAME = new QName("http://sw.uned.es/", "sumar");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: es.uned.sw
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://sw.uned.es/", name = "sumarResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://sw.uned.es/", name = "sumar")
