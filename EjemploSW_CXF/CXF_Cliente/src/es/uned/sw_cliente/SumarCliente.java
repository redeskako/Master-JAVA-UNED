...
import es.uned.sw.Cuentas;
import es.uned.sw.CuentasImpl;
import es.uned.sw.CuentasService;
import es.uned.sw.Sumar;
import es.uned.sw.SumarResponse;
...
public class SumarCliente extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		CuentasService cs = new CuentasService();
		Cuentas c = cs.getCuentasPort();
		
		String resultado = c.sumar(a, b);
