				...
				if (node instanceof Element) {
					...
					case "brief_summary":
						...
						for (int j = 0; j < briefSummaryNodes.getLength(); j++) {
							...
							case "textblock":
								cs.setBriefSummary(nodeTexto.getTextContent());
								break;
							}
						}
						break;
					case "detailed_description":
						...
						for (int j = 0; j < detailedDescriptionNodes.getLength(); j++) {
							...
							switch (nodeTexto.getNodeName()) {
							case "textblock":
								cs.setDetailedDescription(nodeTexto.getTextContent());
								break;
							}
						}
					case "study_design":
					...
					case "primary_outcome":
						...
						for (int j = 0; j < primaryOutcomeNodes.getLength(); j++) {
							...
							case "measure":
								cs.setPrimaryOutcomeMeasure(nodePO.getTextContent());
								break;
							}
						}
					case "overall_status":
						...
						for (int j = 0; j < locationNodes.getLength(); j++) {
							...
							case "facility":
								...
								for (int k = 0; k < facilityNodes.getLength(); k++) {
									...
									case "name":
										cs.setLocationFacilityFame(nodeFacilityName.getTextContent());
										break;
									}
								}
							}
					...
					case "oversight_info":
						...
						for (int j = 0; j < oversightNodes.getLength(); j++) {
							...
							case "authority":
								cs.setOversightInfoAuthority(nodeOverSight.getTextContent());
								break;
							}
						}
					case "secondary_outcome":
						...
						for (int j = 0; j < secondaryOutcomeNodes.getLength(); j++) {
							...
							case "measure":
								cs.setSecondaryOutcomes(nodeSO.getTextContent());
								break;
							}
						}
					case "condition":
					...
					case "responsible_party":
						...
						for (int j = 0; j < responsiblePartiesNodes.getLength(); j++) {
							...
							case "responsible_party_type":
								rp.setResponsiblePartyType(nodeRP.getTextContent());
								break;
							case "investigator_affiliation":
								rp.setInvestigatorAffilation(nodeRP.getTextContent());
								break;
							case "investigator_full_name":
								rp.setInvestigatorFullName(nodeRP.getTextContent());
								break;
							case "investigator_title":
								rp.setInvestigatorTitle(nodeRP.getTextContent());
								break;
							}
						}
					...
					case "intervention":
						...
						for (int j = 0; j < interventionNodes.getLength(); j++) {
							...
							case "intervention_type":
								intervention.setType(nodeIntervention.getTextContent());
								break;
							case "intervention_name":
								intervention.setName(nodeIntervention.getTextContent());
								break;
							}
						}
