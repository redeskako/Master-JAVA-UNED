...
public class SwingController {
	...
	protected void doBusiness(){
		...
		switch(this.getComboOperationRS().getSelectedItem().toString())
		{
			...
			/*****INI$IGN$********/
			case "getByNCT":
				objetoRecuperado = (c.getByNCT(this.getTxtURI().getText()+this.WS_WEBCONTEXT,this.getTxtGetEstudio_Nct_id().getText())!=null ? "List<String>" : null);
				break;
			case "getByEstudio":
				objetoRecuperado = (c.getStudiesByHashtag(this.getTxtURI().getText()+this.WS_WEBCONTEXT,this.getTxtGetByHashtag_hashtag().getText(),Integer.parseInt(this.getTxtGetByHashtag_count().getText()))!=null ? "List<Tweet>" : null);
				break;
			/*****FIN$IGN$********/
		}		
