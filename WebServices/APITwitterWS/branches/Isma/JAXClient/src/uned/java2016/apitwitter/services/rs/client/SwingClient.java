...
public class SwingClient {
	...
	private JTextField txtTextoPruebaEstudios;
	...
	private void initialize() {
		...
		txtTextoPruebaEstudios = new JTextField();
		txtTextoPruebaEstudios.setText("TEXTO PRUEBA ESTUDIOS CLINICOS");
		responseRSScroll.setColumnHeaderView(txtTextoPruebaEstudios);
		txtTextoPruebaEstudios.setColumns(10);
