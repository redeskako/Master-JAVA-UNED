...
@XmlRootElement(name = "getNeighboursResponse", namespace = "http://services.apitwitter.java2016.uned/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getNeighboursResponse", namespace = "http://services.apitwitter.java2016.uned/")
