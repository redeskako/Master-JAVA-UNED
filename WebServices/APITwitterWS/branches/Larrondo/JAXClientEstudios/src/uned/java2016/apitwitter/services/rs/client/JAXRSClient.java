...
public class JAXRSClient {
	...
	public static final String OPERATION_GETBYHASHTAG="estudios/getByHashtag";
	...
	protected void initialize(){
		...
		Client c=ClientBuilder.newBuilder()
				  ...
				  .register(EstudioMessageBodyReader.class) // provider para instancias de Tweet
				  .register(EstudiosMessageBodyReader.class) //provider para List<Tweet>
				  .build();
		this.setRsClient(c);		
	}
	...
	*/
	 ...
	 * @return
	 */
	public ClinicalStudy[] getByHashtag(String URI,String hashtag,int count){
