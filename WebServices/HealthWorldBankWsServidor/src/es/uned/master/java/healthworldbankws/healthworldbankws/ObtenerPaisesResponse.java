 ...
 */
            ...
            /**
            *  ObtenerPaisesResponse bean class
            */
        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns1");
                        ...
                        */
                                    ...
                                    protected es.uned.master.java.healthworldbankws.healthworldbankws.PaisType[] localPais ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           ...
                           /**
                           * Auto generated getter method
                           * @return es.uned.master.java.healthworldbankws.healthworldbankws.PaisType[]
                           */
                           public  es.uned.master.java.healthworldbankws.healthworldbankws.PaisType[] getPais(){
                               return localPais;
                           }
                              ...
                              /**
                               * validate the array for Pais
                               */
                              protected void validatePais(es.uned.master.java.healthworldbankws.healthworldbankws.PaisType[] param){
                              ...
                              * @param param Pais
                              */
                              public void setPais(es.uned.master.java.healthworldbankws.healthworldbankws.PaisType[] param){
                             ...
                             * @param param es.uned.master.java.healthworldbankws.healthworldbankws.PaisType
                             */
                             public void addPais(es.uned.master.java.healthworldbankws.healthworldbankws.PaisType param){
                                   if (localPais == null){
                                   localPais = new es.uned.master.java.healthworldbankws.healthworldbankws.PaisType[]{};
                                   }
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localPais);
                               list.add(param);
                               this.localPais =
                             (es.uned.master.java.healthworldbankws.healthworldbankws.PaisType[])list.toArray(
                            new es.uned.master.java.healthworldbankws.healthworldbankws.PaisType[list.size()]);
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ObtenerPaisesResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ObtenerPaisesResponse",
                           xmlWriter);
                              ...
                              if (localPaisTracker){
                                       if (localPais!=null){
                                            for (int i = 0;i < localPais.length;i++){
                                                if (localPais[i] != null){
                                                 localPais[i].serialize(new javax.xml.namespace.QName("","Pais"),
                                                           xmlWriter);
                                                } else {
    ...
    public static class Factory{
        ...
        */
        public static ObtenerPaisesResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ObtenerPaisesResponse object =
                new ObtenerPaisesResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ObtenerPaisesResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ObtenerPaisesResponse)es.uned.master.java.healthworldbankws.healthworldbankws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list4 = new java.util.ArrayList();
                                    ...
                                    list4.add(es.uned.master.java.healthworldbankws.healthworldbankws.PaisType.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone4){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("","Pais").equals(reader.getName())){
                                                                    list4.add(es.uned.master.java.healthworldbankws.healthworldbankws.PaisType.Factory.parse(reader));
                                                        ...
                                                        object.setPais((es.uned.master.java.healthworldbankws.healthworldbankws.PaisType[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                es.uned.master.java.healthworldbankws.healthworldbankws.PaisType.class,
                                                                list4));
