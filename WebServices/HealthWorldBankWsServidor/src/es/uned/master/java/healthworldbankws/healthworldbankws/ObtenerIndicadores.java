 ...
 */
            ...
            /**
            *  ObtenerIndicadores bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ObtenerIndicadores
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ObtenerIndicadores",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ObtenerIndicadores",
    ...
    public static class Factory{
        ...
        */
        public static ObtenerIndicadores parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ObtenerIndicadores object =
                new ObtenerIndicadores();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ObtenerIndicadores".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ObtenerIndicadores)es.uned.master.java.healthworldbankws.healthworldbankws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
