 ...
 */
    ...
    public static class Factory{
        ...
        */
        public static ObtenerPaises parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ObtenerPaises object =
                new ObtenerPaises();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ObtenerPaises".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ObtenerPaises)es.uned.master.java.healthworldbankws.healthworldbankws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
