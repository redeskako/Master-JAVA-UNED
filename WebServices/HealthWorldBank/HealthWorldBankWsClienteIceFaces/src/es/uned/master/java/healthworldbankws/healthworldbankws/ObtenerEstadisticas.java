 ...
 */
            ...
            /**
            *  ObtenerEstadisticas bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ObtenerEstadisticas
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ObtenerEstadisticas",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ObtenerEstadisticas",
    ...
    public static class Factory{
        ...
        */
        public static ObtenerEstadisticas parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ObtenerEstadisticas object =
                new ObtenerEstadisticas();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ObtenerEstadisticas".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ObtenerEstadisticas)es.uned.master.java.healthworldbankws.healthworldbankws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
