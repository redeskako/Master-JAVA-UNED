...
<div id="container">
	...
	<h4>Crear nueva reserva:</h4>
			...
			<form name="formCrearReserva" action="http://localhost:8080/alphaWS_Servidor/rest/crearReserva" method="post" onsubmit="return controlForm();">
				<div class="cntCampo">
					<label>Usuario</label>
					...
					<div>
						<select name="usuario" required>
							...
							<!-- Se identifica el Usuario logueado -->
							<c:set var="usuarioLog" value="<%= (String)session.getAttribute(\"idSesion\") %>"></c:set>
							...
							<c:set var="usuarios" value="<%= (ArrayList<Usuario>)request.getAttribute(\"arrayUsuarios\") %>"></c:set>
								<c:forEach var="u" items="${ usuarios }">
									<c:if test="${ u.getNombreUsuario().equals(usuarioLog) }">
				...
				<div class="cntCampo">
					<input type="hidden" name="volverIndex" value="http://localhost:8080/alphaWS_Cliente">								
				</div> <!-- fin cntCampo -->
