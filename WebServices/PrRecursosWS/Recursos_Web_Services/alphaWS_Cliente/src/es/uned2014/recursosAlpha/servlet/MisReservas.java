...
/**
 * Servlet implementation class MisReservas Se ejecuta cuando el usuario
 * selecciona "Mis Reservas" en el menú. Se recupera el nombreUsuario logueado y
 * se realiza una llamada al servicio web correspondiente: misReservas. 
...
public class MisReservas extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		WebTarget recurso = cliente.target("http://localhost:8080/alphaWS_Servidor/rest/misReservas"
		...
		String misReservasXml = constructor.get(String.class);
