 ...
 * Gestiona las acciones a realizar relacionadas con los usuarios en función del parámetro 
 * "tipo" del request:
 * 	- Listados
 * 	- Crear
 * 	- Editar/Eliminar
...
public class AccionesUsuarios extends HttpServlet {
	...
	/**
	 * Método en el que se describen las acciones a realizar relacionadas con Usuarios 
	 * (Petición tipo Get)	
	 * @param request 
	 * @param response
	 * @return null
