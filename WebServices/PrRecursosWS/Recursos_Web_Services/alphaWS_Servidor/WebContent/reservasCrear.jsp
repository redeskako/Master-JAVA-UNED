		...
		<div id="content">
			...
			<form name="formCrearReserva" action="./AccionesReservas" method="get" onsubmit="return controlForm();">
				...
				<div class="cntCampo">
					...
					<!-- Combo sucursales sólo visible para responsables: -->
					<lib:mostrar rolMostrar="2">
					<div>
						<select name="sucursal" required>
							...
							<%
							Reserva res = new Reserva();
							ArrayList<Reserva> tsE = (ArrayList<Reserva>) request.getAttribute("sucursalesListado");
							...
							// Crea lista de sucursales
								
							%>
							<option value="<%=res.getIdSucursal()%>"> <%= res.getSucursal() %></option>
							<%
							}
							%>
						</select>
