...
/**
 * Servlet implementation class SalidaUsuario. Cierra la sesión del usuario.
 * 
...
public class SalidaUsuario extends HttpServlet {
	 ...
	 * presiona el botón de salir. (Petición tipo Get)
	 * 
	 * @param request
	 * @param response
	...
	protected void doGet(HttpServletRequest request,
		...
		if (eliminado != null && eliminado.equals("true")) {
			...
			System.out
					.println("La session se ha terminado y elimindao correctamente");
		} else {
