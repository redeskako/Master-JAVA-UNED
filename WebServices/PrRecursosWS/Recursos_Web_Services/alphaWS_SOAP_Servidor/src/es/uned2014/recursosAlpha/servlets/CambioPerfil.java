...
/**
 * Servlet implementation class CambioPerfil. Intercambia la vista entre vista
 * de responsable y de empleado, para que un usuario-responsable tenga acceso a
 * las dos posibles visualizaciones.
 * 
...
public class CambioPerfil extends HttpServlet {
	 ...
	 * usuario-responsable utiliza el link para cambiar de vista
	 * empleado-responsable. (Petición tipo Get)
	 * 
	 * @param request
	 * @param response
	 * @return null
	...
	protected void doGet(HttpServletRequest request,
		...
		// Si ha pulsado el link un responsable, se pasa a vista de empleado, y
		// viceversa:
		if (vista == 1) {
