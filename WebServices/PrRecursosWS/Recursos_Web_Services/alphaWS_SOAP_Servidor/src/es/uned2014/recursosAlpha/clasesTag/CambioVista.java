...
/**
 * Define las acciones correspondientes a un tag personalizado. Cambia del modo
 * de vista de la aplicaciÛn entre vista-empleado y vista-responsable en el caso
 * de que un responsable quiera acceder a una p·gina en el modo de vista
 * incorrecto.
 * 
...
public class CambioVista extends TagSupport {
	...
	private int visible; // obtiene su valor directamente al haber escrito la
							// etiqueta
	...
	public int doStartTag() {
		...
		// Si el rol es de responsable (2), y intenta acceder con la vista
		// incorrecta, se cambia de perfil
