...
<body>
	...
	<div id="container">
		...
		<div id="content">
			...
			String sucursalB = request.getParameter("sucursal");
			%>
				...
				<div class="cntCampo">
					...
					<div>
						<select name="sucursal">
							<%
							// Crea lista opciones con las distintas sucursales
							Reserva rs = new Reserva();
							ArrayList<Reserva> tsRS = (ArrayList<Reserva>) request.getAttribute("sucursalesListado");
							Iterator<Reserva> itRS = tsRS.iterator();
							...
							// resto del listado:		
							while (itRS.hasNext()) {
								rs = (Reserva)itRS.next();
								if(rs.getIdSucursal() == Integer.parseInt(sucursalB)){
									%>
							<option value="<%=rs.getIdSucursal()%>" selected="selected"><%= rs.getSucursal() %></option>
							<%
								} else {
							%>
							<option value="<%=rs.getIdSucursal()%>">
								<%= rs.getSucursal() %></option>
							<%
								}
							} // fin while
						%>
